...
namespace Nop.Services.Authentication.External
{
    ...
    public partial class OpenAuthenticationService : IOpenAuthenticationService
    {
        ...
        public virtual IActionResult Authenticate(OpenAuthenticationParameters parameters, string returnUrl = null)
        {
            ...
            //first sign out from the external authentication scheme
            //TODO this code doesn't work
            var signOutTask = _httpContextAccessor.HttpContext?.Authentication?.SignOutAsync(NopCookieAuthenticationDefaults.ExternalAuthenticationScheme);
            signOutTask.Wait();
